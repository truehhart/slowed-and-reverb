...
| ------------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `check.yml`   | push/PR to `master`, `workflow_call` | `mise run check:fmt` (swift-format lint, strict) + `mise run check:build` (`swift build`) + `mise run test` (Swift Testing). Runs on `macos-15` (arm64) with mise `experimental: true` (core swift backend) and an `actions/cache` on `.build` keyed by `Package.resolved`. Reusable so `release.yml` can gate on it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
